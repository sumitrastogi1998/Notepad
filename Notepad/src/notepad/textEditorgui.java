...
public class textEditorgui extends javax.swing.JFrame {
    ...
    private void pasteTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pasteTextActionPerformed
        try{
            ...
            String sol = (String)pasteText.getTransferData(DataFlavor.stringFlavor);
            textArea.replaceRange(sol,textArea.getSelectionStart(),textArea.getSelectionEnd());
        }catch(Exception e){
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        //myHighlighter o = new myHighlighter();
